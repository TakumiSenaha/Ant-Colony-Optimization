...
ADAPTIVE_PREDICTION_METHOD = "ema"  # 適応的揮発での予測手法（"ar1", "ma", "ema"）
...
PREDICTIVE_HEURISTIC_METHOD = "ema"  # 予測手法（"ar1", "ma", "ema"）
...
if __name__ == "__main__":  # noqa: C901
    ...
    log_filename = "./simulation_result/log_ant_available_bandwidth_ema_autocorr.csv"
